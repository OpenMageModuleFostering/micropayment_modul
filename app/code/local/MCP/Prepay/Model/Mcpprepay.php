 ...
 */
class MCP_Prepay_Model_Mcpprepay extends Mage_Payment_Model_Method_Abstract
{
    public $_code                       = 'mcpprepay';
    protected $_isInitializeNeeded      = true;
    protected $_canUseInternal          = false;
    protected $_canUseForMultishipping  = false;
    protected $_formBlockType	     	= 'mcpservice/form';
    public $_dispatcherUrl              = '/prepay/event/';
    ...
    public function isAvailable($quote=null)
    {
        ...
        $payserviceUrl = $model->getConfigData('billing_url_prepay');
        if(!$payserviceUrl) {
            return false;
        }
