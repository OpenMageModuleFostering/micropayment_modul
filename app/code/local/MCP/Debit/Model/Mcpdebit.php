 ...
 */
class MCP_Debit_Model_Mcpdebit extends Mage_Payment_Model_Method_Abstract
{
    protected $_code                    = 'mcpdebit';
    protected $_formBlockType	     	= 'mcpservice/form';
    public $_dispatcherUrl              = '/lastschrift/event/';
    ...
    public function isAvailable($quote=null)
    {
        ...
        $payserviceUrl = $model->getConfigData('billing_url_debit');
        if(!$payserviceUrl) {
            return false;
        }
